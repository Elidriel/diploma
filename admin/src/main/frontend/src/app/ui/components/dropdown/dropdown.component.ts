...
export class TCDropdownComponent implements OnInit {
  ...
  @ContentChild(TCDropdownButtonComponent, { static: true })
  public dropdownButton: TCDropdownButtonComponent;
  @ContentChild(TCDropdownContentComponent, { static: true })
  public dropdownContent: TCDropdownContentComponent;
